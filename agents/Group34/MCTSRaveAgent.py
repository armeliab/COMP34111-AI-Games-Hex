...
class MCTSRaveAgent(AgentBase):
    """
    Python wrapper for MCTS+RAVE C++ agent.
    Implements RAVE (Rapid Action Value Estimation) as described in:
    ...
    def _launch_process(self, board_size: int):
        ...
        if not self._binary_path.exists():
            ...
            raise FileNotFoundError(
                ...
                "Build it with: "
                "g++ agents/Group34/cpp/MCTSRaveAgent.cpp -O3 -std=c++17 -o agents/Group34/bin/mcts_rave_agent"
            )
